    ...
    <Box bg="gray.100" minH="100vh" p={5}>
      ...
      <VStack spacing={6}>
        ...
        <Flex direction="column" alignItems="center" p={6} bg="white" boxShadow="md" borderRadius="md">
          <Image borderRadius="full" boxSize="150px" src={generatePlaceholderImage("John Doe")} alt="Profile Image" mb={4} />
        ...
        <Flex direction="column" alignItems="center" p={6} bg="white" boxShadow="md" borderRadius="md">
          <Image borderRadius="full" boxSize="150px" src={generatePlaceholderImage("Jane Smith")} alt="Jane Smith Profile Image" mb={4} />
          <Text fontSize="xl" fontWeight="bold">Jane Smith</Text>
          <Text fontSize="md">Data Scientist</Text>
          <Button mt={4} colorScheme="blue">View Profile</Button>
        </Flex>
        <Flex direction="column" alignItems="center" p={6} bg="white" boxShadow="md" borderRadius="md">
          <Image borderRadius="full" boxSize="150px" src={generatePlaceholderImage("Ahmed Khan")} alt="Ahmed Khan Profile Image" mb={4} />
          <Text fontSize="xl" fontWeight="bold">Ahmed Khan</Text>
          <Text fontSize="md">Mobile Developer</Text>
          <Button mt={4} colorScheme="blue">View Profile</Button>
        </Flex>
        <Flex direction="column" alignItems="center" p={6} bg="white" boxShadow="md" borderRadius="md">
          <Image borderRadius="full" boxSize="150px" src={generatePlaceholderImage("Emily Zhao")} alt="Emily Zhao Profile Image" mb={4} />
